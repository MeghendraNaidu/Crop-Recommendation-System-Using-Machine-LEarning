...
# Load dataset
crop = pd.read_csv(r"C:\Users\Meghendra\Desktop\Mini Project\Crop Recommendation\Crop_recommendation.csv")
...
test_samples = [
    [88, 38, 15, 25.08, 65.92, 6.45, 62.49],  # Example 1
    [25, 76, 24 , 15.33, 24.91, 5.56, 135.33],  # Example 2
    [39, 37, 15, 28.99, 83.78, 6.82, 59.84],  # Example 3
]
